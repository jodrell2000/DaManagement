            ...
            if ( await databaseFunctions.checkVideoDataExists( this.ytid() ) ) {
                await databaseFunctions.getSongInfoData( this.ytid() )
                    .then( ( songInfo ) => {
                        ...
                        chatFunctions.botSpeak( "The song " + songInfo.trackName + " by " + songInfo.artistName + " has been played " + songInfo.playCount + " times and was first played " + songInfo.firstPlay, data );
                    } )
            } else {
