...
const databaseFunctions = () => {
    ...
    return {
        ...
        getSongInfoData: async function ( ytid ) {
            ...
            const whenQuery = "SELECT MIN(DATE(tp.whenPlayed)) as firstPlay, count(tp.id) AS playCount FROM videoData vd JOIN tracksPlayed tp ON tp.videoData_id=vd.id  where vd.artistName = ? AND vd.trackDisplayName = ?;";
