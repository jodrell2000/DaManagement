...
const commandFunctions = ( bot ) => {
    ...
    generalCommands.wibble = ({ data, userFunctions, chatFunctions }) => {userFunctions.chargeMe(5, data, chatFunctions, databaseFunctions, () => userFunctions.wibble(data, chatFunctions));};
