...
module.exports = {
    ...
    eddiePics: [
        ...
        "https://media.giphy.com/media/32hIXtawGFLZC/giphy.gif",
        "https://media.giphy.com/media/5xtDarqlsEW6F7F14Fq/giphy-downsized-large.gif",
        "https://media.giphy.com/media/6QMV47HASp6eI/giphy.gif",
        "https://media.giphy.com/media/LagYTGYTlTLeE/giphy.gif",
        "https://media.giphy.com/media/3o6vXNLzXdW4sbFRGo/giphy.gif"
    ],
    ...
    suggestionsMessages: [
        "Send us your command suggestions: https://bit.ly/80scd"
    ],

    rulesMessages: [
        "Check out the official room rules: https://bit.ly/ilt80s"
    ],
    ...
    jumpPics: [
        "https://media.giphy.com/media/qEeaNtuOZllIs/giphy.gif",
    ],

    flirtMessages: [
        "Hey @receiverUsername, how YOU doin’?!"
    ],
